const UNIT_CONFIG = {
    ...
    flow: {
        ...
        units: {
            ...
            m3h: { label: 'm3/h', symbol: 'm3/h', fromBase: (v) => v * 3.6, toBase: (v) => v / 3.6, step: 0.1, digits: 2 },
    ...
    volume: {
        ...
        units: {
            ...
            m3: { label: 'm3', symbol: 'm3', fromBase: (v) => v / 1000, toBase: (v) => v * 1000, step: 0.01, digits: 3 },
