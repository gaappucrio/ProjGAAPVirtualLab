...
const TOOLTIP_TEXTS = {
    pt: {
        ...
        conexao: {
            ...
            diametroSugerido: 'Diâmetro calculado por d = sqrt(4Q / piV), usando a vazão atual ou alvo do trecho e a velocidade de projeto.',
    ...
    en: {
        ...
        conexao: {
            ...
            diametroSugerido: 'Diameter calculated by d = sqrt(4Q / piV), using the current or target line flow and design velocity.',
