...
export const EPSILON_FLOW = 0.0001;
export const DEFAULT_PIPE_DIAMETER_M = 0.08;
...
export const lpsToM3s = (value) => value * LPS_TO_M3S;
export const m3sToLps = (value) => value * M3S_TO_LPS;
export const areaFromDiameter = (diameterM) => Math.PI * Math.pow(diameterM / 2, 2);
export const pressureFromHeadBar = (headM, density) => (density * GRAVITY * headM) / BAR_TO_PA;
