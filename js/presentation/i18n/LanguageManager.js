...
const TOOLTIP_TEXTS = {
    pt: {
        ...
        componentes: {
            ...
            sinkFinalPressure: 'Pressão calculada no ponto final da rede, na entrada desta saída.',
    ...
    en: {
        ...
        componentes: {
            ...
            sinkFinalPressure: 'Calculated pressure at the network endpoint, at this outlet inlet.',
...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            endpoints: 'Extremos',
            selectMonitorable: 'Selecione um Tanque, Bomba ou Cano',
            tank: 'Tanque',
            pump: 'Bomba',
            pipe: 'Cano',
            ...
            emptyPrimary: 'Clique em um tanque, bomba ou Cano para exibir um gráfico.',
            emptySecondary: 'Clique em outro tanque, bomba ou Cano para comparar.',
            statusCompare: 'Comparando os dois últimos itens monitoráveis selecionados.',
            statusOne: 'Clique em outro tanque, bomba ou Cano para dividir a visualização expandida.',
            statusEmpty: 'Clique em um tanque, bomba ou Cano para exibir um gráfico aqui.',
    ...
    en: {
        ...
        chart: {
            ...
            endpoints: 'Endpoints',
            selectMonitorable: 'Select a Tank, Pump, or Pipe Segment',
            tank: 'Tank',
            pump: 'Pump',
            pipe: 'Pipe segment',
            component: 'Component',
            ...
            emptyPrimary: 'Click a tank, pump, or pipe segment to display a chart.',
            emptySecondary: 'Click another tank, pump, or pipe segment to compare.',
            statusCompare: 'Comparing the last two selected monitorable items.',
            statusOne: 'Click another tank, pump, or pipe segment to split the expanded view.',
            statusEmpty: 'Click a tank, pump, or pipe segment to display a chart here.',
