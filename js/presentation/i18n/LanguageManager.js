...
const TOOLTIP_TEXTS = {
    pt: {
        ...
        conexao: {
            titulo: 'Conexão',
            Cano: 'Mostra o componente de origem e o componente de destino conectados por este Cano.',
            diametro: 'Diâmetro hidráulico interno usado para calcular a área de escoamento.',
            vazaoAtual: 'Vazão efetivamente resolvida no Cano no instante atual da simulação.',
            vazaoAlvo: 'Vazão estimada antes da dinâmica transitória do Cano suavizar a resposta.',
            deltaPTrecho: 'Queda de pressão calculada entre a origem e o destino do Cano.',
            ...
            rugosidade: 'Rugosidade absoluta da parede interna do Cano.',
            ...
            usarVazaoAtualProjeto: 'Copia a vazão atual ou alvo do Cano para a base de dimensionamento. O valor capturado não vira condição de contorno da simulação.',
            diametroSugerido: 'Diâmetro calculado por d = sqrt(4Q / (pi v)), usando a vazão atual ou alvo do Cano e a velocidade de projeto.',
            aplicarDiametroSugerido: 'Aplica o diâmetro sugerido ao Cano para aproximar a velocidade de projeto configurada.',
            velocidade: 'Velocidade média do fluido dentro do Cano, calculada a partir da vazão e da área interna.',
            ...
            tempoResidencia: 'Tempo estimado para o volume interno do Cano ser atravessado pela vazão atual.',
            respostaHidraulica: 'Tempo característico usado para suavizar a variação de vazão no Cano.',
            temperaturaFluido: 'Temperatura atual do fluido que escoa neste Cano.'
        },
        componentes: {
            ...
            sinkPressure: 'Contrapressão imposta pela fronteira de saída, depois da perda de entrada do dreno.',
            sinkCurrentFlow: 'Vazão atualmente absorvida pela saída.',
            sinkFluid: 'Fluido atualmente recebido na saída.',
            sinkFluidTemperature: 'Temperatura do fluido recebido nesta saída.',
            sinkFinalPressure: 'Pressão calculada no ponto final da rede, imediatamente antes da perda de entrada desta saída.',
            sinkEntryPressureDrop: 'Queda de pressão entre o ponto final da rede e a contrapressão imposta pela saída.',
            sinkEntryK: 'Coeficiente de perda localizado na entrada da saída/dreno. Explica a diferença entre a pressão final da rede e a contrapressão imposta.',
            ...
            pumpNpshr: 'NPSH Requerido (NPSHr) nominal da bomba. Este valor indica a energia mínima necessária na sucção para evitar cavitação quando a bomba opera a 100% de acionamento na sua vazão máxima de projeto.',
            ...
            pumpPressureIncrease: 'Aumento de pressão efetivamente gerado pela bomba no ponto de operação atual.',
            ...
            valveCv: 'Capacidade intrínseca de vazão da válvula em plena abertura, usando a convenção industrial de Cv. Com o PA ativo, este parâmetro fica bloqueado; o controlador modula somente a abertura.',
            valveFlowCoefficientUnit: 'Escolhe se o coeficiente de vazão será exibido e editado como Cv ou Kv. O solver converte Kv para Cv internamente sem mudar a física da válvula.',
            valveK: 'Perda localizada adicional introduzida pelo corpo e internos da válvula. Com o PA ativo, este parâmetro fica bloqueado; o controlador modula somente a abertura.',
            ...
            heatExchangerUA: 'Coeficiente global de transferência de calor multiplicado pela área. Valores maiores aproximam a temperatura de saída da temperatura de serviço.',
            heatExchangerInletTemperature: 'Temperatura atual do fluido que entra na Corrente 1.',
            heatExchangerOutletTemperature: 'Temperatura calculada do fluido após a troca na Corrente 1.',
            heatExchangerInletTemperature1: 'Temperatura do fluido que entra na Corrente 1 (in1).',
            heatExchangerOutletTemperature1: 'Temperatura calculada do fluido na saída da Corrente 1 (out1).',
            heatExchangerInletTemperature2: 'Temperatura do fluido que entra na Corrente 2 (in2).',
            heatExchangerOutletTemperature2: 'Temperatura calculada do fluido na saída da Corrente 2 (out2).',
            heatExchangerDeltaT: 'Diferença de temperatura na Corrente 1.',
            heatExchangerDeltaT2: 'Diferença de temperatura na Corrente 2.',
            heatExchangerDuty: 'Potência térmica transferida entre as correntes.',
            heatExchangerFlow: 'Vazão atual na Corrente 1.',
            heatExchangerFlow2: 'Vazão atual na Corrente 2.',
            ...
            heatExchangerEffectiveness: 'Efetividade térmica calculada pelo método NTU.',
            heatExchangerPressureDrop: 'Queda de pressão na Corrente 1.',
            heatExchangerPressureDrop2: 'Queda de pressão na Corrente 2.',
            heatExchangerDualStreamAlert: 'Aviso de operação acoplada quando duas correntes estão conectadas ao trocador de calor.',
            heatExchangerServiceTemperatureDisabled: 'Temperatura de serviço desabilitada pois a Corrente 2 está conectada e governa a troca térmica.',
            ...
            tankResidenceTime: 'Tempo estimado de residência do fluido no tanque, calculado por volume atual dividido pela vazão de saída; se não houver saída, usa a vazão de entrada como estimativa de troca.',
            tankSpActive: 'Liga ou desliga o controlador automático de nível do tanque. Enquanto ativo, o PID modula apenas válvulas e bombas associadas operam fixas em 100%.',
            tankSetpoint: 'Nível desejado para o controlador automático em percentual da capacidade útil.',
            tankKp: 'Ganho proporcional do controlador de nível. Usa erro normalizado: valores na faixa de 2 a 8 costumam modular sem saturar imediatamente.',
            tankKi: 'Ganho integral do controlador de nível. Usa erro acumulado no tempo; aumente com cuidado para evitar oscilação.',
            tankKd: 'Ganho derivativo do controlador de nível. Reage à velocidade de variação do erro; mantenha em 0 para comportamento PI.',
            tankPiController: 'Controle automático do nível do tanque por sinal proporcional, integral e derivativo, atuando somente nas válvulas e mantendo bombas associadas fixas em 100%.'
        }
    },
    en: {
        unidades: {
        ...
        painel: {
            ...
            estadoVazio: 'Click on a component or a pipe to edit the plant physical parameters.',
        ...
        conexao: {
            titulo: 'Connection',
            Cano: 'Shows the source and target components connected by this line.',
            ...
            tempoResidencia: 'Estimated time for the current flow to pass through the line internal volume.',
            respostaHidraulica: 'Characteristic time used to smooth flow variation in this line.',
            temperaturaFluido: 'Current temperature of the fluid flowing in this line.'
        },
        componentes: {
            ...
            sinkPressure: 'Backpressure imposed by the outlet boundary, after the sink inlet loss.',
            sinkCurrentFlow: 'Flow currently absorbed by the outlet.',
            sinkFluid: 'Fluid currently received at the outlet.',
            sinkFluidTemperature: 'Temperature of the fluid received at this outlet.',
            sinkFinalPressure: 'Calculated pressure at the network endpoint, immediately before this outlet inlet loss.',
            sinkEntryPressureDrop: 'Pressure drop between the network endpoint and the backpressure imposed by the outlet.',
            sinkEntryK: 'Minor-loss coefficient at the outlet/sink inlet. It explains the difference between network final pressure and imposed backpressure.',
            ...
            pumpNpshr: 'Nominal Required NPSH (NPSHr). This value indicates the minimum suction energy needed to avoid cavitation when the pump operates at 100% drive and maximum design flow.',
            ...
            pumpPressureIncrease: 'Pressure increase effectively generated by the pump at the current operating point.',
            ...
            pumpNpshCondition: 'Qualitative summary of the Avaiable NPSH and NPSHr margin.',
            ...
            valveCv: 'Intrinsic valve flow capacity at full opening, using the industrial Cv convention. With active SP, this parameter is locked; the controller modulates only the opening.',
            valveFlowCoefficientUnit: 'Chooses whether the flow coefficient is displayed and edited as Cv or Kv. The solver converts Kv to Cv internally without changing the valve physics.',
            valveK: 'Additional minor loss introduced by the valve body and internals. With active SP, this parameter is locked; the controller modulates only the opening.',
            valveThrottlingLoss: 'Includes an extra hydraulic penalty associated with partial-opening throttling. It is off by default for DWSIM/IEC-style pure Cv/Kv comparisons.',
            ...
            valveProfiles: {
                ...
                custom: 'Custom: unlocks the individual parameters so you can manually define unit, Cv/Kv, K, throttling, characteristic, rangeability, and stroke time.'
            },
            ...
            heatExchangerInletTemperature: 'Current fluid temperature entering Stream 1.',
            heatExchangerOutletTemperature: 'Calculated fluid temperature after exchange in Stream 1.',
            heatExchangerInletTemperature1: 'Fluid temperature entering Stream 1 (in1).',
            heatExchangerOutletTemperature1: 'Calculated fluid temperature at Stream 1 outlet (out1).',
            heatExchangerInletTemperature2: 'Fluid temperature entering Stream 2 (in2).',
            heatExchangerOutletTemperature2: 'Calculated fluid temperature at Stream 2 outlet (out2).',
            heatExchangerDeltaT: 'Temperature difference across Stream 1.',
            heatExchangerDeltaT2: 'Temperature difference across Stream 2.',
            heatExchangerDuty: 'Thermal power transferred between the streams.',
            heatExchangerFlow: 'Current flow through Stream 1.',
            heatExchangerFlow2: 'Current flow through Stream 2.',
            ...
            heatExchangerEffectiveness: 'Thermal effectiveness calculated using the NTU method.',
            heatExchangerPressureDrop: 'Pressure drop across Stream 1.',
            heatExchangerPressureDrop2: 'Pressure drop across Stream 2.',
            heatExchangerDualStreamAlert: 'Coupled operation warning when two streams are connected to the heat exchanger.',
            heatExchangerServiceTemperatureDisabled: 'Service temperature disabled because Stream 2 is connected and governs heat exchange.',
            ...
            tankResidenceTime: 'Estimated fluid residence time in the tank, calculated as current volume divided by outlet flow; if there is no outlet flow, inlet flow is used as a turnover estimate.',
            tankSpActive: 'Turns the automatic tank level controller on or off. While active, the PID modulates valves only and associated pumps run fixed at 100%.',
            tankSetpoint: 'Desired level for the automatic controller as a percentage of usable capacity.',
            tankKp: 'Proportional gain of the level controller. It uses normalized error: values from 2 to 8 usually modulate without immediate saturation.',
            tankKi: 'Integral gain of the level controller. It uses error accumulated over time; increase carefully to avoid oscillation.',
            tankKd: 'Derivative gain of the level controller. It reacts to error rate of change; keep it at 0 for PI behavior.',
            tankPiController: 'Automatic tank level control by proportional, integral, and derivative signal, actuating valves only and keeping associated pumps fixed at 100%.'
        }
    }
};
...
const TEXTS = {
    pt: {
        ...
        toolbar: {
            ...
            importDwsim: 'Importar DWSIM',
            importDwsimTitle: 'Importa uma simulação do DWSIM (.dwxmz ou .dwxm), traduzindo componentes e conexões para o laboratório.',
            importDwsimError: 'Não foi possível importar o arquivo DWSIM.',
            importDwsimEmpty: 'Nenhum componente compatível foi encontrado no arquivo DWSIM.',
            importDwsimSuccess: ({ count }) => `Importação DWSIM concluída: ${count} componente(s) criado(s).`,
            importDwsimSkipped: ({ count }) => `${count} componente(s) DWSIM sem equivalente foram ignorados(s).`,
        ...
        chart: {
            ...
            endpoints: 'Extremos',
            selectMonitorable: 'Selecione um Componente',
            tank: 'Tanque',
            pump: 'Bomba',
            valve: 'Válvula',
            heatExchanger: 'Trocador de calor',
            pipe: 'Cano',
            pipeGroup: 'Perfil de canos',
            component: 'Componente',
            pumpSubtitle: 'Curva: carga, eficiência e NPSHr',
            valveSubtitle: 'Curva: Cv efetivo, Delta P e K equivalente por abertura',
            heatExchangerSubtitle: ({ tempUnit, mode } = {}) => mode === 'thermal'
                ? `Perfil de troca de calor (${tempUnit} × kW)`
                : `Perfil de temperatura (${tempUnit}) ao longo do trocador`,
            heatExchangerPosition: 'Posição no trocador',
            heatExchangerHeatDuty: 'Carga térmica Q',
            heatExchangerModePosition: 'Perfil Espacial (T × Comprimento)',
            heatExchangerModeThermal: 'Perfil Térmico (T × Q)',
            operatingPointLine: 'Ponto de operação',
            stream1: 'Corrente 1',
            stream2: 'Corrente 2',
            utility: 'Utilidade',
            stream1Inlet: 'Entrada Corrente 1 (in1)',
            stream1Outlet: 'Saída Corrente 1 (out1)',
            stream2Inlet: 'Entrada Corrente 2 (in2)',
            stream2Outlet: 'Saída Corrente 2 (out2)',
            utilityService: 'Temperatura de serviço',
            operatingPoints: 'Pontos de operação',
            temperature: 'Temperatura',
            pipeSubtitle: ({ pressureUnit, lengthUnit }) => `Pressão (${pressureUnit}) ao longo da distância (${lengthUnit})`,
            pipeGroupTitle: ({ count }) => `Perfil de canos (${count} trechos)`,
            pipeGroupLegend: ({ count }) => `${count} trechos de cano`,
            pipeGroupSubtitle: ({ count, pressureUnit, lengthUnit }) => `${count} trechos: pressão (${pressureUnit}) ao longo da distância acumulada (${lengthUnit})`,
            waiting: 'Aguardando gráfico',
            emptyPrimary: 'Clique em um tanque, bomba, válvula, trocador de calor ou Cano para exibir um gráfico.',
            emptySecondary: 'Clique em outro tanque, bomba, válvula, trocador de calor ou Cano para comparar.',
            statusCompare: 'Comparando os itens monitoráveis. Use o x para liberar um slot antes de adicionar outro gráfico.',
            statusOne: 'Clique em outro tanque, bomba, válvula, trocador de calor ou Cano para ocupar o slot livre.',
            statusEmpty: 'Clique em um tanque, bomba, válvula, trocador de calor ou Cano para exibir um gráfico aqui.',
            ...
            dragHint: 'Arraste para trocar posição. Solte sobre outro gráfico de cano do mesmo sistema para aglutinar os trechos.',
    ...
    en: {
        ...
        toolbar: {
            ...
            importDwsim: 'Import DWSIM',
            importDwsimTitle: 'Imports a DWSIM simulation (.dwxmz or .dwxm), translating components and connections into the lab.',
            importDwsimError: 'The DWSIM file could not be imported.',
            importDwsimEmpty: 'No compatible components were found in the DWSIM file.',
            importDwsimSuccess: ({ count }) => `DWSIM import complete: ${count} component(s) created.`,
            importDwsimSkipped: ({ count }) => `${count} DWSIM component(s) without an equivalent were skipped.`,
        ...
        chart: {
            ...
            endpoints: 'Endpoints',
            selectMonitorable: 'Select a Component',
            tank: 'Tank',
            pump: 'Pump',
            valve: 'Valve',
            heatExchanger: 'Heat Exchanger',
            pipe: 'Pipe segment',
            pipeGroup: 'Pipe profile',
            component: 'Component',
            pumpSubtitle: 'Curve: head, efficiency, and NPSHr',
            valveSubtitle: 'Curve: effective Cv, Delta P, and equivalent K by opening',
            heatExchangerSubtitle: ({ tempUnit, mode } = {}) => mode === 'thermal'
                ? `Heat exchange profile (${tempUnit} × kW)`
                : `Temperature profile (${tempUnit}) along the exchanger`,
            heatExchangerPosition: 'Position along exchanger',
            heatExchangerHeatDuty: 'Heat duty Q',
            heatExchangerModePosition: 'Spatial Profile (T × Length)',
            heatExchangerModeThermal: 'Thermal Profile (T × Q)',
            operatingPointLine: 'Operating point',
            stream1: 'Stream 1',
            stream2: 'Stream 2',
            utility: 'Utility',
            stream1Inlet: 'Inlet Stream 1 (in1)',
            stream1Outlet: 'Outlet Stream 1 (out1)',
            stream2Inlet: 'Inlet Stream 2 (in2)',
            stream2Outlet: 'Outlet Stream 2 (out2)',
            utilityService: 'Service temperature',
            operatingPoints: 'Operating points',
            temperature: 'Temperature',
            pipeSubtitle: ({ pressureUnit, lengthUnit }) => `Pressure (${pressureUnit}) along distance (${lengthUnit})`,
            pipeGroupTitle: ({ count }) => `Pipe profile (${count} sections)`,
            pipeGroupLegend: ({ count }) => `${count} pipe sections`,
            pipeGroupSubtitle: ({ count, pressureUnit, lengthUnit }) => `${count} sections: pressure (${pressureUnit}) along accumulated distance (${lengthUnit})`,
            waiting: 'Waiting for chart',
            emptyPrimary: 'Click on a tank, pump, valve, heat exchanger, or pipe segment to display a chart.',
            emptySecondary: 'Click on another tank, pump, valve, heat exchanger, or pipe segment to compare.',
            statusCompare: 'Comparing monitorable items. Use x to free a slot before adding another chart.',
            statusOne: 'Click on another tank, pump, valve, heat exchanger, or pipe segment to occupy the free slot.',
            statusEmpty: 'Click on a tank, pump, valve, heat exchanger, or pipe segment to display a chart here.',
            ...
            dragHint: 'Drag to swap position. Drop on another pipe chart from the same system to merge sections.',
...
const LEGACY_PT_TO_EN = {
    ...
    'Clique em uma porta de saida e depois em uma porta de entrada para criar o Cano.': 'Click an output port and then an input port to create the line.',
    ...
    'Clique em um componente ou Cano para abrir as propriedades no painel lateral.': 'Click a component or line to open its properties in the side panel.',
    ...
    'Clique em outro tanque, bomba ou Cano para comparar os dois ultimos graficos.': 'Click another tank, pump, or pipe segment to compare the last two charts.',
    'Clique em outro tanque, bomba, válvula ou Cano para comparar os dois ultimos graficos.': 'Click another tank, pump, valve, or pipe segment to compare the last two charts.',
    'Clique em outro tanque, bomba, válvula, trocador de calor ou Cano para comparar os dois ultimos graficos.': 'Click another tank, pump, valve, heat exchanger, or pipe segment to compare the last two charts.',
    'Grafico 1': 'Chart 1',
    'Grafico 2': 'Chart 2',
    ...
    'Clique em outro tanque, bomba ou Cano para comparar.': 'Click another tank, pump, or pipe segment to compare.',
    'Clique em outro tanque, bomba, válvula ou Cano para comparar.': 'Click another tank, pump, valve, or pipe segment to compare.',
    'Clique em outro tanque, bomba, válvula, trocador de calor ou Cano para comparar.': 'Click another tank, pump, valve, heat exchanger, or pipe segment to compare.',
    'Geral': 'General',
    'Avançado': 'Advanced',
    ...
    'Posição no trocador': 'Position along exchanger',
    ...
    'Fluido no Cano': 'Line Fluid',
    'Fluido no Tanque': 'Tank Fluid',
    'Fluido Recebido': 'Received Fluid',
    'Fluido atualmente recebido nesta saída.': 'Fluid currently received at this outlet.',
    'Temperatura do fluido recebido nesta saída.': 'Temperature of the fluid received at this outlet.',
    'Temperatura atual do fluido que escoa neste Cano.': 'Current temperature of the fluid flowing in this line.',
    'Temperatura do fluido ou mistura atualmente armazenado no tanque.': 'Temperature of the fluid or mixture currently stored in the tank.',
    'Densidade do Fluido (kg/m³)': 'Fluid Density (kg/m³)',
    'Viscosidade do Fluido (Pa.s)': 'Fluid Viscosity (Pa.s)',
    'Fluido atualmente transportado neste Cano.': 'Fluid currently transported by this line.',
    ...
    'Densidade do fluido ou mistura que está no Cano.': 'Density of the fluid or mixture in the line.',
    'Viscosidade dinâmica do fluido ou mistura que está no Cano.': 'Dynamic viscosity of the fluid or mixture in the line.',
    'Densidade': 'Density',
    ...
    'Carga máxima da curva': 'Maximum curve head',
    'Aumento de pressão atual': 'Current pressure increase',
    ...
    'NPSH disponível mostra o que o sistema está entregando na sucção agora. NPSH requerido mostra o que a bomba está exigindo agora no ponto de operação. Folga contra cavitação é a diferença entre os dois; valor negativo indica risco de cavitação.': 'Avaiable NPSH shows what the system is delivering at suction now. Required NPSH shows what the pump is requiring at the current operating point. Cavitation margin is the difference between the two; a negative value indicates cavitation risk.',
    ...
    'Tempo de residência (s)': 'Residence time (s)',
    'Controlador de nível (PID)': 'Level controller (PID)',
    ...
    'Aqui ficam os parâmetros de bocais e sintonia do controlador PID. Eles refinam a dinâmica do tanque e costumam ser ajustados só em estudos mais detalhados.': 'Nozzle and PID controller tuning parameters are here. They refine tank dynamics and are usually adjusted only in more detailed studies.',
    'Abertura': 'Opening',
    ...
    'Válvula sob controle do ponto de ajuste do tanque. O PA modula a abertura; o perfil ainda pode ser alterado na aba Avançado.': 'Valve under tank set point control. SP modulates the opening; the profile can still be changed in the Advanced tab.',
    'Abertura efetiva (%)': 'Effective opening (%)',
    'Queda de pressão atual': 'Current pressure drop',
    'Temperatura de serviço': 'Service temperature',
    'Duas Correntes Conectadas': 'Two Connected Streams',
    'O trocador opera com troca térmica acoplada entre as Correntes 1 e 2. A temperatura de serviço fixa está desabilitada pois a temperatura da Corrente 2 governa o processo.': 'The heat exchanger operates with coupled heat transfer between Streams 1 and 2. The fixed service temperature is disabled because Stream 2 temperature governs the process.',
    'Operação com utilidade: a troca térmica utiliza a temperatura de serviço configurada.': 'Utility operation: heat exchange uses the configured service temperature.',
    'Desabilitada: a Corrente 2 está conectada e governa a temperatura de troca.': 'Disabled: Stream 2 is connected and governs the exchange temperature.',
    'Troca Térmica Global': 'Global Heat Transfer',
    'Modo do gráfico': 'Chart profile mode',
    'Define a exibição do perfil térmico no monitor: Espacial (T vs Comprimento) ou Térmico (T vs Q).': 'Sets the thermal profile display in the monitor: Spatial (T vs Length) or Thermal (T vs Q).',
    'Perfil Espacial (T × Comprimento)': 'Spatial Profile (T × Length)',
    'Perfil Térmico (T × Q)': 'Thermal Profile (T × Q)',
    'Área de troca (m²)': 'Heat exchange area (m²)',
    'Área de troca': 'Heat exchange area',
    'Área superficial total de transferência de calor.': 'Total heat transfer surface area.',
    'Coeficiente global U (W/m²·K)': 'Global heat transfer coeff U (W/m²·K)',
    'Coeficiente U': 'U coefficient',
    'Coeficiente global de transferência de calor U.': 'Overall heat transfer coefficient U.',
    ...
    'Carga térmica máxima': 'Maximum heat exchange',
    'Troca térmica teórica máxima admissível pela Segunda Lei da Termodinâmica.': 'Theoretical maximum heat exchange allowed by the Second Law of Thermodynamics.',
    ...
    'Temperatura de saída 1': 'Stream 1 outlet temperature',
    'Delta T Corrente 1': 'Stream 1 Delta T',
    'Delta T Corrente 1 (°C)': 'Stream 1 Delta T (°C)',
    'Queda de pressão 1': 'Stream 1 pressure drop',
    'Corrente 2 (Serviço - in2 / out2)': 'Stream 2 (Service - in2 / out2)',
    'Vazão Corrente 2': 'Stream 2 Flow',
    'Temperatura de entrada 2': 'Stream 2 inlet temperature',
    'Temperatura de saída 2': 'Stream 2 outlet temperature',
    'Delta T Corrente 2': 'Stream 2 Delta T',
    'Delta T Corrente 2 (°C)': 'Stream 2 Delta T (°C)',
    'Queda de pressão 2': 'Stream 2 pressure drop',
    'Análise Térmica Rigorosa': 'Rigorous Thermal Analysis',
    'LMTD (Média Logarítmica)': 'Log Mean Temperature Difference (LMTD)',
    'LMTD (Diferença Média Logarítmica)': 'Log Mean Temperature Difference (LMTD)',
    'Diferença Média Logarítmica de Temperatura entre as correntes: força motriz térmica média ao longo do trocador.': 'Log Mean Temperature Difference between streams: average thermal driving force along the exchanger.',
    'Fator de correção FT': 'FT correction factor',
    'Fator de correção LMTD': 'LMTD correction factor',
    'Fator FT de correção geométrica shell-and-tube aplicado ao LMTD em arranjos multipasse/misto.': 'Shell-and-tube geometric correction factor FT applied to LMTD in multi-pass/mixed arrangements.',
    'Pinch Point (ΔT mín)': 'Pinch Point (min ΔT)',
    'Menor diferença pontual de temperatura entre os dois fluidos ao longo do trocador (ponto de estrangulamento térmico).': 'Smallest localized temperature difference between the two fluids along the exchanger (thermal pinch point).',
    'Parâmetros Hidráulicos e de Limite': 'Hydraulic and Limit Parameters',
    'Perda local K': 'Minor loss K',
    'Parâmetros de análise térmica rigorosa (LMTD, fator FT, pinch point), limites de efetividade e perda de carga do trocador.': 'Rigorous thermal analysis parameters (LMTD, FT factor, pinch point), effectiveness limits, and exchanger pressure drop.',
    ...
    'Com o ponto de ajuste ativo, o tanque modula somente a abertura; desative o PA para alterar unidade, Cv/Kv, K, estrangulamento, curva, rangeabilidade ou tempo de curso.': 'With the set point active, the tank modulates only the opening; disable SP to change unit, Cv/Kv, K, throttling, curve, rangeability, or stroke time.',
    'Com o ponto de ajuste ativo, trocar o perfil altera a geometria/curva usada pelo controle. Cv/Kv, K, estrangulamento, curva, rangeabilidade e tempo de curso continuam bloqueados para evitar ajustes finos acidentais durante a malha fechada.': 'With the set point active, changing the profile changes the geometry/curve used by control. Cv/Kv, K, throttling, curve, rangeability, and stroke time stay locked to avoid accidental fine tuning during closed-loop operation.',
    'Unidade do coeficiente de vazão': 'Flow coefficient unit',
    'Coeficiente de vazão (Cv)': 'Flow coefficient (Cv)',
    'Coeficiente de vazão (Kv)': 'Flow coefficient (Kv)',
    'Coeficiente de perda (K)': 'Loss coefficient (K)',
    'Considerar perda de estrangulamento': 'Include throttling loss',
    'Característica da válvula': 'Valve characteristic',
    'Válvula restritiva': 'Restrictive valve',
    'A válvula está muito aberta e ainda consome uma parcela alta da pressão disponível. Aumente o Cv ou reduza K para liberar a passagem sem mascarar a perda nos canos.': 'The valve is very open and still consumes a high share of the available pressure. Increase Cv or reduce K to free the passage without hiding pipe losses.',
    'A válvula manual está muito aberta e ainda consome uma parcela alta da pressão disponível. Aumente o Cv ou reduza K manual para liberar a passagem sem mascarar a perda nos canos.': 'The manual valve is very open and still consumes a high share of the available pressure. Increase Cv or reduce manual K to free the passage without hiding pipe losses.',
    'Válvula no limite': 'Valve at the limit',
    'A queda de pressão na válvula já é relevante para a abertura atual. O sistema ainda opera, mas a válvula pode estar virando o gargalo hidráulico.': 'The pressure drop across the valve is already relevant for the current opening. The system still operates, but the valve may be becoming the hydraulic bottleneck.',
    'A queda de pressão na válvula manual já é relevante para a abertura atual. O sistema ainda opera, mas vale revisar Cv, K ou o perfil se ela não deveria limitar a rede.': 'The pressure drop across the manual valve is already relevant for the current opening. The system still operates, but Cv, K, or the profile should be reviewed if it should not limit the network.',
    'Ajustar Cv e K': 'Adjust Cv and K',
    'Parâmetros ajustados para reduzir a restrição da válvula.': 'Parameters adjusted to reduce the valve restriction.',
    'Desative o set point do tanque para editar esta válvula manualmente.': 'Turn off the tank set point to edit this valve manually.',
    'A válvula já está dentro dos limites de ajuste automático.': 'The valve is already within the automatic adjustment limits.',
    'Igual porcentagem': 'Equal percentage',
    'Linear': 'Linear',
    'Rangeabilidade': 'Rangeability',
    'Tempo de curso (s)': 'Stroke time (s)',
    'Aba indicada para escolher perfis de válvula. Use Personalizado quando quiser ajustar unidade, Cv/Kv, K, estrangulamento, característica, rangeabilidade e tempo de curso individualmente.': 'Tab for choosing valve profiles. Use Custom when you want to adjust unit, Cv/Kv, K, throttling, characteristic, rangeability, and stroke time individually.',
    'Conexão': 'Connection',
    'Diâmetro Interno': 'Internal diameter',
    'Velocidade de Projeto': 'Design velocity',
    'Velocidade de Projeto (m/s)': 'Design velocity (m/s)',
    'Velocidade desejada (m/s)': 'Target velocity (m/s)',
    ...
    'Sugestão de diâmetro': 'Diameter suggestion',
    'Aplicar diâmetro sugerido': 'Apply suggested diameter',
    'Vazão Alvo': 'Target flow',
    'Vazão transitória alvo': 'Transient target flow',
    'Queda de Pressão no Cano': 'Line pressure drop',
    ...
    'não aplicado': 'not applied',
    'Os parâmetros desta aba refinam perdas distribuídas, perdas locais e a resposta transitória da linha. São úteis quando você quer aproximar melhor a hidráulica do Cano.': 'Parameters in this tab refine distributed losses, minor losses, and the transient response of the line. They are useful when you want a closer approximation of line hydraulics.',
    ...
    'Ganho derivativo': 'Derivative gain',
