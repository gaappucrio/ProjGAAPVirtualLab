...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            endpoints: 'Extremos',
            selectMonitorable: 'Selecione um Tanque, Bomba, Válvula ou Cano',
            tank: 'Tanque',
            pump: 'Bomba',
            valve: 'Válvula',
            pipe: 'Cano',
    ...
    en: {
        ...
        chart: {
            ...
            endpoints: 'Endpoints',
            selectMonitorable: 'Select a Tank, Pump, Valve, or Pipe Segment',
            tank: 'Tank',
            pump: 'Pump',
            valve: 'Valve',
            pipe: 'Pipe segment',
            ...
            emptyPrimary: 'Click a tank, pump, valve, or pipe segment to display a chart.',
            emptySecondary: 'Click another tank, pump, valve, or pipe segment to compare.',
            statusCompare: 'Comparing monitorable items. Use x to free a slot before adding another chart.',
            statusOne: 'Click another tank, pump, valve, or pipe segment to occupy the free slot.',
