...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            statusCompare: 'Comparando os itens monitoráveis. Arraste um card para trocar posição; solte um Cano sobre outro do mesmo sistema para aglutinar trechos.',
            statusOne: 'Clique em outro tanque, bomba, válvula ou Cano para dividir a visualização expandida.',
    ...
    en: {
        ...
        chart: {
            ...
            statusCompare: 'Comparing monitorable items. Drag a card to swap position; drop one pipe segment on another from the same system to merge sections.',
            statusOne: 'Click another tank, pump, valve, or pipe segment to split the expanded view.',
