...
const TOOLTIP_TEXTS = {
    pt: {
        ...
        conexao: {
            ...
            tempoResidencia: 'Tempo estimado para o volume interno do trecho ser atravessado pela vazão atual.',
...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            endpoints: 'Extremos',
            selectMonitorable: 'Selecione um Tanque, Bomba ou Trecho',
            tank: 'Tanque',
            pump: 'Bomba',
            pipe: 'Trecho',
            ...
            emptyPrimary: 'Clique em um tanque, bomba ou trecho para exibir um gráfico.',
            emptySecondary: 'Clique em outro tanque, bomba ou trecho para comparar.',
            statusCompare: 'Comparando os dois últimos itens monitoráveis selecionados.',
            statusOne: 'Clique em outro tanque, bomba ou trecho para dividir a visualização expandida.',
            statusEmpty: 'Clique em um tanque, bomba ou trecho para exibir um gráfico aqui.',
...
const LEGACY_PT_TO_EN = {
    ...
    'Clique em outro tanque, bomba ou trecho para comparar os dois ultimos graficos.': 'Click another tank, pump, or pipe segment to compare the last two charts.',
    'Grafico 1': 'Chart 1',
    'Grafico 2': 'Chart 2',
    ...
    'Clique em outro tanque, bomba ou trecho para comparar.': 'Click another tank, pump, or pipe segment to compare.',
    'Geral': 'General',
    'Avançado': 'Advanced',
