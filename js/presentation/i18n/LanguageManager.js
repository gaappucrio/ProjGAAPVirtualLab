...
const LEGACY_PT_TO_EN = {
    ...
    'Com o ponto de ajuste ativo, o tanque modula somente a abertura; desative o PA para alterar Cv, K, curva, rangeabilidade ou tempo de curso.': 'With the set point active, the tank modulates only the opening; disable SP to change Cv, K, curve, rangeability, or stroke time.',
