...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            heatExchangerSubtitle: ({ tempUnit }) => `Perfil de temperatura (${tempUnit}) ao longo do trocador`,
    ...
    en: {
        ...
        chart: {
            ...
            heatExchangerSubtitle: ({ tempUnit }) => `Temperature profile (${tempUnit}) along the exchanger`,
