...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            emptyPrimary: 'Clique em um tanque, bomba, válvula ou Cano para exibir um gráfico.',
            emptySecondary: 'Clique em outro tanque, bomba, válvula ou Cano para comparar.',
            statusCompare: 'Comparando os itens monitoráveis. Use o x para liberar um slot antes de adicionar outro gráfico.',
            statusOne: 'Clique em outro tanque, bomba, válvula ou Cano para ocupar o slot livre.',
    ...
    en: {
        ...
        chart: {
            ...
            emptyPrimary: 'Click on a tank, pump, valve, or pipe segment to display a chart.',
            emptySecondary: 'Click on another tank, pump, valve, or pipe segment to compare.',
            statusCompare: 'Comparing monitorable items. Use x to free a slot before adding another chart.',
            statusOne: 'Click on another tank, pump, valve, or pipe segment to occupy the free slot.',
            statusEmpty: 'Click on a tank, pump, valve, or pipe segment to display a chart here.',
