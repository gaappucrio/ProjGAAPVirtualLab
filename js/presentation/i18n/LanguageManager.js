...
const TOOLTIP_TEXTS = {
    pt: {
        ...
        componentes: {
            ...
            tankControlMode: 'Escolhe o algoritmo do controle de nível. PID é determinístico; Fuzzy usa funções trapezoidais nas extremidades, triangulares no centro e defuzzificação por média ponderada.',
    ...
    en: {
        ...
        componentes: {
            ...
            tankControlMode: 'Selects the level-control algorithm. PID is deterministic; Fuzzy uses trapezoidal edge sets, triangular center sets, and weighted-average defuzzification.',
...
const TEXTS = {
    pt: {
        ...
        chart: {
            ...
            effectiveFlowCoefficient: ({ unit }) => `${unit} efetivo`,
    ...
    en: {
        ...
        chart: {
            ...
            effectiveFlowCoefficient: ({ unit }) => `Effective ${unit}`,
...
const LEGACY_PT_TO_EN = {
    ...
    'Modo do controlador': 'Controller mode',
    ...
    'Aqui ficam os parâmetros de bocais, perdas e sintonia do controlador PID. Eles refinam a dinâmica do tanque e costumam ser ajustados só em estudos mais detalhados.': 'Nozzle, loss, and PID controller tuning parameters are here. They refine tank dynamics and are usually adjusted only in more detailed studies.',
    'Abertura': 'Opening',
